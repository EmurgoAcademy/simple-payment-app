...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf addOrg3/fabric-ca/axis/msp addOrg3/fabric-ca/axis/tls-cert.pem addOrg3/fabric-ca/axis/ca-cert.pem addOrg3/fabric-ca/axis/IssuerPublicKey addOrg3/fabric-ca/axis/IssuerRevocationPublicKey addOrg3/fabric-ca/axis/fabric-ca-server.db
